...
tools/menu-check.html        open in a browser to see what the apps see
...
**`tools/menu-check.html` answers the only question that matters after a
publish**, which is not whether the payload is live but whether the app finds
